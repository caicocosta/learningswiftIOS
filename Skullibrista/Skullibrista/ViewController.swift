...
//  Skullibrista
//
//  Created by Caico Saler Oliveira Costa on 08/11/21.
//
...
class ViewController: UIViewController {
    ...
    func checkGameOver() {
        ...
        if difference > 0.25 {
            ...
            let secondsPlayeds = round(Date().timeIntervalSince(startDate))
            lbTimePlayed.text = "Você jogou durante \(secondsPlayeds) segundos"
        }
    }
